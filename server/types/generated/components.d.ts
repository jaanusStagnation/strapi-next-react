...
export interface SharedFeaturedCategories extends Struct.ComponentSchema {
  collectionName: 'components_shared_featured_categories';
  info: {
    description: '';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'shared.featured-categories': SharedFeaturedCategories;
